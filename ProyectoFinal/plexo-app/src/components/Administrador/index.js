          ...
          <div className="d-flex justify-content-around align-items-center mb-3 " id="d-flex">
            ...
            <div className="d-flex justify-content-between custom1 productsAddSearch_admin">              
              ...
              <div className="input-group  ">
                  ...
                  <input type="search" className=" searchBar_admin" placeholder="Buscar" />
              </div>
            </div>
          </div>
          <div className="list-group">
            {productsData.map(product => (
              <div className="list-group-item d-flex justify-content-between align-items-center mb-2 custom-item .container_item productUp_admin" key={product.id}>
