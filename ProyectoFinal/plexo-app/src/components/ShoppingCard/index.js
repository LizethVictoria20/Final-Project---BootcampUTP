...
import "./styles-shopping.css"; // Asumiendo que tienes un archivo de estilos CSS
...
const Product = ({ product, index, increment, decrement }) => (
  <div className="product">
    <div className="product-info">
      <button onClick={async () => console.log(await api.get("/carts"))}>
        carts
      </button>
      <button onClick={async () => console.log(await api.get("/users"))}>
        users
      </button>
      <button onClick={async () => console.log(await api.get("/auth/logout"))}>
        logout
      </button>
      <button
        onClick={async () => console.log(await api.get("/users/loginuser"))}
      >
        user.data
      </button>
